										...
										<tbody>
											<c:forEach var="cEnqList" items="${cEnqList }">
												<tr role="row" class="tr-hover"	>
													...
													<td>
													<button class="btn btn-outline-primary" value="${cEnqList.enqNo}"
													onclick='enqOpen(this)'													
													style="font-size:20px; z-index:99;"><i class="fa fa-envelope-open-o"></i></button>
										...
										<tbody>
											<c:forEach var="myEnqList" items="${myEnqList }">
												<tr role="row" class="tr-hover"	>
													...
													<td>
													<button class="btn btn-outline-primary" value="${myEnqList.enqNo}"
													onclick='enqOpen(this)'													
													style="font-size:20px; z-index:99;"><i class="fa fa-envelope-open-o"></i></button>
